...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'InformatiChats.data';
      var REMOTE_PACKAGE_BASE = 'InformatiChats.data';
...
Module['FS_createPath']("/res", "fonts", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_InformatiChats.data');

      };
      Module['addRunDependency']('datafile_InformatiChats.data');
    ...
    loadPackage({"files": [{"filename": "/res/fonts/Mx437_IBM_CGA.ttf", "start": 0, "end": 35952}, {"filename": "/res/fonts/Mx437_Portfolio_6x8.ttf", "start": 35952, "end": 69120}], "remote_package_size": 69120});
...
var wasmBinaryFile;
  wasmBinaryFile = 'InformatiChats.wasm';
...
var ASM_CONSTS = {
  ...
  var WEBRTC = {peerConnectionsMap:{},dataChannelsMap:{},nextId:1,allocUTF8FromString:function(str) {
...
unexportedRuntimeFunction('WEBRTC', false);
unexportedRuntimeFunction('WEBSOCKET', false);
